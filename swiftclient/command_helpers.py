...
def print_account_headers(headers, output_manager):
    output_manager.print_headers(headers,
...
def print_container_headers(headers, output_manager):
    output_manager.print_headers(headers,
...
def print_object_headers(headers, output_manager):
    output_manager.print_headers(headers,
